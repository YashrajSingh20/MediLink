...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-healthcare-backend-super-secret-key-12345')
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # CorsMiddleware must be placed as high as possible in the stack
